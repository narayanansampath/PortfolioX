      ...
      child: Flex(
          ...
          children: [
            ...
            Expanded(
              ...
              items: [
                ProjectWidget(title: "JustMemes"),
                ProjectWidget(title: "AQ-Detector"),
                ProjectWidget(title: "Missing Person Finder"),
                ProjectWidget(title: "Text-Recogniser"),
                ProjectWidget(title: "RSS HSS Blood Donors Bureau"),
              ],
              height: 170,
